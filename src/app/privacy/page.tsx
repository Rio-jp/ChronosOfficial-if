    ...
    return (
        <main className="min-h-screen bg-black text-white selection:bg-cyan-500/30">
            ...
            <div className="fixed inset-0 z-0 pointer-events-none">
                <div className="absolute top-[-20%] left-[-10%] h-[600px] w-[600px] rounded-full bg-cyan-500/10 blur-[100px]" />
                <div className="absolute bottom-[-20%] right-[-10%] h-[600px] w-[600px] rounded-full bg-purple-500/10 blur-[100px]" />
            </div>
